...
<section class="py-5 mt-5">
  <div class="container">
    ...
    <h5 class="text-center mb-5" style="font-weight: 700; font-size: 2rem; letter-spacing: 0.05rem; color: #333;">CMA BUILDING</h5>
    ...
    <div class="row text-center">
      ...
      <div class="col-12 col-sm-6 col-lg-4 mb-4">
        <div class="card border-0 shadow-sm img-animate">
          <div class="image-container">
            <img class="card-img-top img-fluid rounded enlarge-image" src="{{ asset('images/cma1.jpg') }}" alt="MACLAB" data-bs-toggle="modal" data-bs-target="#imageModal" data-bs-image="{{ asset('images/maclab.jpg') }}">
          </div>
          <div class="card-body">
      ...
      <div class="col-12 col-sm-6 col-lg-4 mb-4">
        <div class="card border-0 shadow-sm img-animate">
          <div class="image-container">
            <img class="card-img-top img-fluid rounded enlarge-image" src="{{ asset('images/cma2.jpg') }}" alt="PTC RESTROOM" data-bs-toggle="modal" data-bs-target="#imageModal" data-bs-image="{{ asset('images/restroom.jpg') }}">
          </div>
          <div class="card-body">
      ...
      <div class="col-12 col-sm-6 col-lg-4 mb-4">
        <div class="card border-0 shadow-sm img-animate">
          <div class="image-container">
            <img class="card-img-top img-fluid rounded enlarge-image" src="{{ asset('images/cma3.jpg') }}" alt="FEMALE RESTROOM" data-bs-toggle="modal" data-bs-target="#imageModal" data-bs-image="{{ asset('images/r-female.jpg') }}">
          </div>
          <div class="card-body">
            <h3 class="card-title" style="font-weight: 600; font-size: 1.5rem;">ROOMS</h3>
      ...
      <div class="col-12 col-sm-6 col-lg-4 mb-4">
        <div class="card border-0 shadow-sm img-animate">
          <div class="image-container">
            <img class="card-img-top img-fluid rounded enlarge-image" src="{{ asset('images/cma4.jpg') }}" alt="PTC ROOMS" data-bs-toggle="modal" data-bs-target="#imageModal" data-bs-image="{{ asset('images/ptc-3.jpg') }}">
          </div>
          <div class="card-body">
      ...
      <div class="col-12 col-sm-6 col-lg-4 mb-4">
        <div class="card border-0 shadow-sm img-animate">
          <div class="image-container">
            <img class="card-img-top img-fluid rounded enlarge-image" src="{{ asset('images/cma5.jpg') }}" alt="CITE OFFICE" data-bs-toggle="modal" data-bs-target="#imageModal" data-bs-image="{{ asset('images/office.jpg') }}">
          </div>
          <div class="card-body">
            <h3 class="card-title" style="font-weight: 600; font-size: 1.5rem;">CMA ROOMS</h3>
      ...
      <div class="col-12 col-sm-6 col-lg-4 mb-4">
        <div class="card border-0 shadow-sm img-animate">
          <div class="image-container">
            <img class="card-img-top img-fluid rounded enlarge-image" src="{{ asset('images/cma6.jpg') }}" alt="PTC ROOMS" data-bs-toggle="modal" data-bs-target="#imageModal" data-bs-image="{{ asset('images/ptc-4.jpg') }}">
          </div>
          <div class="card-body">
      ...
      <div class="col-12 col-sm-6 col-lg-4 mb-4">
        <div class="card border-0 shadow-sm img-animate">
          <div class="image-container">
            <img class="card-img-top img-fluid rounded enlarge-image" src="{{ asset('images/cma7.jpg') }}" alt="PTC ROOMS" data-bs-toggle="modal" data-bs-target="#imageModal" data-bs-image="{{ asset('images/ptc-4.jpg') }}">
          </div>
          <div class="card-body">
